...
import SidenavPharmacien from './SidenavPharmacien';
const Pharmacien = (props) => {
  ...
  return (
    <div id='wrapper'>
      <SidenavPharmacien isOpen={isSidebarOpen} toggleSidebar={toggleSidebar} web3={props.web3}
